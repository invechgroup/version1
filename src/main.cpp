...
uint256 hashGenesisBlock("0xdd615a9f59ccd25ad70ed74d6077b4d7ee8d10ee341bdaed0eaf79d07bb3f6e7");
...
static const int64 nTargetSpacing = 5 * 60; // Invechcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x011479073a6375cd92228d63164827f11fbdd40e92cd9a258228275e053e8eeb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c36c5d1bad5f9c3102966c7d0d2b03dfd3d90cc4123f3fe6e8d450efc6af4b1d8ce3cca9c1e019f12080d1ae66ed3cfa0590c2cb1a14c1d0a48e9521c47d10ec") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1537174276;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085526194;

        if (fTestNet)
        {
            block.nTime    = 1537174249;
            block.nNonce   = 388153656;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xab3c8cf206bb1480d8db54c7c2102d75b0f8336af969ccc7a9f4017161892bd1"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb5, 0xd3 }; // Invechcoin: increase each by adding 2 to bitcoin's value.
